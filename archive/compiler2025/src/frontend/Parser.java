...
public class Parser {
    ...
    private static final Set<TokenType> EXP_START_TOKENS = EnumSet.of(
            TokenType.PLUS, TokenType.MINU, TokenType.NOT, TokenType.IDENFR, TokenType.LPARENT, TokenType.INTCON
    );
    ...
    private ArrayList<ConstDef> parseConstDefs() {
    ...
    private ArrayList<VarDef> parseVarDefs() {
