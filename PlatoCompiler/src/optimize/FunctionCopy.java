    ...
    private static Instruction createClonedInstruction(Instruction originalInstr, BasicBlock parentBlock) {
        ...
        if (originalInstr instanceof GetintInst) {
            ...
            if (brInst.isConditional()) {
                clonedBrInst = new BrInst(clonedBlock, getOrCreate(brInst.getCondition()),
                ...
                clonedBrInst = new BrInst(clonedBlock,
                        (BasicBlock) getOrCreate(brInst.getTrueBlock()));
            ...
            return new LoadInst(getOrCreate(loadInst.getPointer()), clonedBlock);
            ...
            return new RetInst(getOrCreate(retInst.getReturnValue()), clonedBlock);
            ...
            return new TruncInst(getOrCreate(truncInst.getOriginValue()),
                    truncInst.getValueType(), clonedBlock);
        } else {
